...
/***/ function(module, exports, __webpack_require__) {
	...
	var _plugin = __webpack_require__(49);
	...
	var router = new _vueRouter2.default({ history: true, root: '/' });
	var fetch = (0, _fetch2.default)({
	    baseUrl: '/api/page'
	});
	var changeTitleAndWeixinShare = function changeTitleAndWeixinShare(data) {
	...
	var route = function () {
	    ...
	    var _loop = function _loop(key) {
	        var routeItem = _router2.default[key];
	
	        compose = function compose(routeItem, component) {
	            ...
	            component.mixins = [{
	                ...
	                route: {
	                    data: function data(_ref) {
	                        ...
	                        if (routeItem.url) {
	                            var query = (0, _fetch.parseParam)(params);
	                            var url = routeItem.url;
	                            if (query.length > 0) {
	                                url += '?' + query;
	                            }
	                            return fetch.get(url).then(function (data) {
	                                var pageData = (0, _assign2.default)({}, data, routeItem.pageData || {});
	                                changeTitleAndWeixinShare(pageData);
	                                return { pageData: pageData };
	                            });
	                        } else {
	                            var pageData = (0, _assign2.default)({}, routeItem.pageData || {});
	                            changeTitleAndWeixinShare(pageData);
	                ...
	                components: {
	                    Navbar: _navbar2.default, Toolbar: _toolbar2.default
	                }
	            }];
	            return component;
	        };
	    ...
	    for (var key in _router2.default) {
	        var compose;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adaption = __webpack_require__(51);
	
	var _adaption2 = _interopRequireDefault(_adaption);
	...
	exports.default = {
	    install: function install(Vue, options) {
	        ...
	        //添加fastclick
	        options.fastclick && _fastclick2.default.attach(document.body);
	        //添加屏幕适配
	        (0, _adaption2.default)(Vue, options.adaption);
	        //UUID生成器
	        (0, _UUID2.default)(Vue);
	    }
	}; /**
	    * Created by ifchangetoclzp on 2016/7/14.
	    */
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    '/': {
	        ...
	        text: '大家',
	        component: function component(reslove) {
	            __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(56)]; (reslove.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	    ...
	    '/add': {
	        ...
	        text: '添加',
	        component: function component(reslove) {
	            __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(58)]; (reslove.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	    ...
	    '/person': {
	        ...
	        text: '个人',
	        component: function component(reslove) {
	            __webpack_require__.e/* require */(3, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(187)]; (reslove.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        }
	    },
	    '/404': {
	        name: '404',
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(16)(IteratorPrototype, __webpack_require__(89)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = getNormalFetch;
	exports.getPassErrorFetch = getPassErrorFetch;
	
	__webpack_require__(138);
	
	var _FetchError = __webpack_require__(139);
	 ...
	 */
	var Fetch = function () {
	    (0, _createClass3.default)(Fetch, null, [{
	        key: 'parseParam',
	        value: function parseParam(obj) {
	    ...
	    (0, _createClass3.default)(Fetch, [{
	        ...
	        key: 'saveCache',
	        value: function saveCache(response) {
	            this.cache[response[this.options.cacheKeyName]] = response;
	        }
	    }, {
	        key: 'send',
	        value: function () {
	            var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(url, _ref) {
	                var method = _ref.method;
	                var headers = _ref.headers;
	                var body = _ref.body;
	                var cache = _ref.cache;
	
	                var fetch, key, response, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, middleware;
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                fetch = this.fetch;
	                                key = encodeURIComponent(url + '_' + method + '_' + (body || ''));
	                                ...
	                                return _context.abrupt('return', this.cache[key].response);
	                            ...
	                            case 10:
	                                ...
	                                _context.prev = 14;
	                                _iterator = (0, _getIterator3.default)(this.middleware);
	                            ...
	                            case 38:
	                                if (cache) {
	                                    (0, _defineProperty2.default)(response, this.options.cacheKeyName, {
	                                        enumerable: false,
	                                        writable: false,
	                                        value: key
	                                    });
	                                    this.cache[key] = {
	                                        response: response, createdTime: new Date()
	                                    };
	                                }
	...
	function getFetch(options) {
	    ...
	    return fetch.use(function (respose) {
	        if (respose.ok) {
	    ...
	    }).use(function (respose) {
	        if (respose.status) {
	            return respose.data;
	        } else {
	            return new _FetchError2.default(respose.data);
	        }
	    });
	}
	
	function getNormalFetch(options) {
	    return getFetch(options).use(function (respose) {
	...
	function getPassErrorFetch(options) {
	    return getFetch(options).use(function (respose) {
	        if (respose instanceof _FetchError2.default) {
	            throw respose;
	        } else {
	            return respose;
	        }
	...
	var parseParam = exports.parseParam = Fetch.parseParam;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ErrorBase2 = __webpack_require__(153);
	
	var _ErrorBase3 = _interopRequireDefault(_ErrorBase2);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var FetchError = function (_ErrorBase) {
	    (0, _inherits3.default)(FetchError, _ErrorBase);
	
	    function FetchError(obj) {
	        (0, _classCallCheck3.default)(this, FetchError);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FetchError).call(this, '向服务器发送信息错误:' + obj.message));
	
	        _this.name = 'FetchError';
	        _this.status = obj.status;
	        _this.errorObject = obj;
	        return _this;
	    }
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(14)(Function.call, __webpack_require__(125).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ErrorBase = function (_Error) {
	    (0, _inherits3.default)(ErrorBase, _Error);
	
	    function ErrorBase(message) {
	        (0, _classCallCheck3.default)(this, ErrorBase);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ErrorBase).call(this, message));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	    //STATE
	    STATE_CHANGE_ADD: function STATE_CHANGE_ADD(state) {
	        state.stateType = 'add';
	        state.page.cancelAllEditor();
	    },
	    STATE_CHANGE_ATTR: function STATE_CHANGE_ATTR(state) {
	        state.stateType = 'attr';
	    },
	    STATE_CHANGE_ANIM_LIST: function STATE_CHANGE_ANIM_LIST(state) {
	        state.stateType = 'anim-list';
	    },
	    STATE_CHANGE_ANIM_ADD: function STATE_CHANGE_ANIM_ADD(state) {
	        state.stateType = 'anim-add';
	    },
	    STATE_CHANGE_INIT: function STATE_CHANGE_INIT(state) {
	        state.stateType = 'init';
	        state.page.cancelAllEditor();
	    },
	
	    //ITEM
	    ITEM_ADD: function ITEM_ADD(state, item) {
	        state.page.push(item);
	    },
	    ITEM_COPY: function ITEM_COPY(state) {
	        state.page.copyItems();
	    },
	    ITEM_DEL: function ITEM_DEL(state) {
	        state.page.delItems();
	    },
	    ITEM_UP_INDEX: function ITEM_UP_INDEX(state) {
	        state.page.upIndex();
	    },
	    ITEM_DOWN_INDEX: function ITEM_DOWN_INDEX(state) {
	        state.page.downIndex();
	    },
	    ITEM_EDITOR: function ITEM_EDITOR(state, item) {
	    ...
	    //MULT
	    MULT_CHANGE: function MULT_CHANGE(state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageItem = __webpack_require__(196);
	...
	var _lodash3 = __webpack_require__(208);
	...
	var Page = function () {
	    ...
	    (0, _createClass3.default)(Page, [{
	        ...
	        value: function push(item) {
	            switch (item.type) {
	                case 'image':
	                    this.itemList.push(new _ImageItem2.default(item));
	                    break;
	                case 'text':
	                    break;
	            }
	        ...
	        key: 'cancelAllEditor',
	        value: function cancelAllEditor() {
	            this.itemList.forEach(function (n) {
	                return n.editor = false;
	            });
	        }
	    }, {
	        key: 'hasEditorItem',
	        value: function hasEditorItem() {
	            return !!(0, _lodash2.default)(this.itemList, function (n) {
	                return n.editor;
	            });
	        }
	    }, {
	        key: 'getFirstEditorItem',
	        value: function getFirstEditorItem() {
	            return (0, _lodash2.default)(this.itemList, function (n) {
	                return n.editor;
	            });
	        }
	        ...
	        value: function delItems() {
	            this.itemList = (0, _lodash4.default)(this.itemList, function (n) {
	                return !n.editor;
	            });
	        }
	    }, {
	        ...
	        value: function copyItems() {
	            this.itemList = this.itemList.concat((0, _lodash4.default)(this.itemList, function (n) {
	                return n.editor;
	            }).map(function (n) {
	                return n.copy();
	            }));
	        ...
	        key: 'upIndex',
	        value: function upIndex() {
	            for (var i = this.itemList.length - 1; i >= 0; i--) {
	                if (this.itemList[i].editor && i < this.itemList.length - 1) {
	                    var _itemList$splice = this.itemList.splice(i, 1);
	
	                    var _itemList$splice2 = (0, _slicedToArray3.default)(_itemList$splice, 1);
	
	                    var item = _itemList$splice2[0];
	        ...
	        key: 'downIndex',
	        value: function downIndex() {
	            for (var i = 0; i < this.itemList.length; i++) {
	                if (i > 0 && this.itemList[i].editor) {
	                    var _itemList$splice3 = this.itemList.splice(i, 1);
	
	                    var _itemList$splice4 = (0, _slicedToArray3.default)(_itemList$splice3, 1);
	
	                    var item = _itemList$splice4[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageItem = function (_Item) {
	    ...
	    function ImageItem(_ref) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ImageItem).call(this, { type: 'image', data: data, x: x, y: y }));
	
	        _this.width = width;
	        _this.height = height;
	        _this.x = x || (document.documentElement.clientWidth - _this.width) / 2;
	        _this.y = y || (document.documentElement.clientHeight - _this.height) / 2;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Animation = __webpack_require__(198);
	...
	var Item = function () {
	    function Item(_ref) {
	        ...
	        this.editor = false;
	        this.animations = new _Animation2.default();
	        var event = {
	            isMove: undefined,
	            start: {
	                sx: 0,
	        ...
	        this.setIsMove = function (value) {
	            event.IsMove = value;
	        };
	        this.getIsMove = function () {
	            return event.IsMove;
	        };
	        this.setStart = function (_ref2) {
	            var sx = _ref2.sx;
	            var sy = _ref2.sy;
	            var x = _ref2.x;
	            var y = _ref2.y;
	    ...
	    (0, _createClass3.default)(Item, [{
	        ...
	        key: 'addAnimation',
	        value: function addAnimation(animItem) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AnimationItem = __webpack_require__(199);
	...
	var Animation = function () {
	    ...
	    (0, _createClass3.default)(Animation, [{
	        key: 'add',
	        value: function add(animItem) {
	            animItem.parent = this;
	            this.timeLine[0].push(new _AnimationItem2.default(animItem));
	        }
	    }, {
	        key: 'move',
	        value: function move(index, timeLine) {}
	    }]);
	    return Animation;
	}(); /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimationItem = function () {
	    function AnimationItem(_ref) {
	        ...
	        var data = _ref.data;
	        (0, _classCallCheck3.default)(this, AnimationItem);
	    ...
	    (0, _createClass3.default)(AnimationItem, [{
	        key: "touchStart",
	        value: function touchStart(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(201),
	    baseFind = __webpack_require__(202),
	    baseFindIndex = __webpack_require__(203),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
	 */
	var stringToPath = __webpack_require__(206);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
	 */
	var baseFilter = __webpack_require__(209),
	    baseIteratee = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".navbar {\n  position: fixed;\n  background: #373737;\n  color: #fff;\n  left: 0;\n  top: 0;\n  height: 44px;\n  width: 100%;\n  box-sizing: border-box;\n  font-size: 17px;\n  margin: 0;\n  z-index: 500;\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n}\n.navbar .navbar-inner {\n  width: 100%;\n  height: 100%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  padding: 0 8px;\n  box-sizing: border-box;\n}\n.navbar .navbar-inner a {\n  color: #fff;\n}\n.navbar .navbar-inner .iconfont {\n  font-size: 20px;\n}\n.navbar .navbar-inner .center {\n  font-weight: 600;\n  font-size: 17px;\n  text-align: center;\n  margin: 0;\n  position: relative;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  line-height: 44px;\n  -ms-flex-negative: 10;\n      flex-shrink: 10;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n", "", {"version":3,"sources":["/./public/app/modules/navbar/index.vue"],"names":[],"mappings":"AAAA;EACE,gBAAgB;EAChB,oBAAoB;EACpB,YAAY;EACZ,QAAQ;EACR,OAAO;EACP,aAAa;EACb,YAAY;EACZ,uBAAuB;EACvB,gBAAgB;EAChB,UAAU;EACV,aAAa;EACb,oCAA4B;UAA5B,4BAA4B;CAC7B;AACD;EACE,YAAY;EACZ,aAAa;EACb,qBAAc;EAAd,qBAAc;EAAd,cAAc;EACd,0BAA+B;MAA/B,uBAA+B;UAA/B,+BAA+B;EAC/B,0BAAoB;MAApB,uBAAoB;UAApB,oBAAoB;EACpB,eAAe;EACf,uBAAuB;CACxB;AACD;EACE,YAAY;CACb;AACD;EACE,gBAAgB;CACjB;AACD;EACE,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;EACnB,UAAU;EACV,mBAAmB;EACnB,iBAAiB;EACjB,wBAAwB;EACxB,oBAAoB;EACpB,kBAAkB;EAClB,sBAAgB;MAAhB,gBAAgB;EAChB,qBAAc;EAAd,qBAAc;EAAd,cAAc;EACd,0BAAoB;MAApB,uBAAoB;UAApB,oBAAoB;CACrB","file":"index.vue","sourcesContent":[".navbar {\n  position: fixed;\n  background: #373737;\n  color: #fff;\n  left: 0;\n  top: 0;\n  height: 44px;\n  width: 100%;\n  box-sizing: border-box;\n  font-size: 17px;\n  margin: 0;\n  z-index: 500;\n  backface-visibility: hidden;\n}\n.navbar .navbar-inner {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0 8px;\n  box-sizing: border-box;\n}\n.navbar .navbar-inner a {\n  color: #fff;\n}\n.navbar .navbar-inner .iconfont {\n  font-size: 20px;\n}\n.navbar .navbar-inner .center {\n  font-weight: 600;\n  font-size: 17px;\n  text-align: center;\n  margin: 0;\n  position: relative;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  line-height: 44px;\n  flex-shrink: 10;\n  display: flex;\n  align-items: center;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n\n\n<div class=\"navbar\">\n    <div class=\"navbar-inner\">\n        <div class=\"left\">\n            <slot name=\"left\">\n                <a><i class=\"iconfont icon-back\"></i><span>返回</span></a>\n            </slot>\n        </div>\n        <div class=\"center\">\n            <slot>主页</slot>\n        </div>\n        <div class=\"right\">\n            <slot name=\"right\">\n                <a><i class=\"iconfont icon-menu\"></i></a>\n            </slot>\n        </div>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] public\\app\\modules\\toolbar\\index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".toolbar {\n  position: fixed;\n  background-color: rgba(247, 247, 248, 0.85);\n  height: 50px;\n  z-index: 5001;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  box-sizing: border-box;\n  font-size: 17px;\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n}\n.toolbar:before {\n  top: 0;\n  display: block;\n  -webkit-transform-origin: 50% 0;\n          transform-origin: 50% 0;\n  position: absolute;\n  height: 1px;\n  background-color: #c4c4c4;\n  z-index: 15;\n  width: 100%;\n  content: '';\n  right: auto;\n  left: 0;\n}\n.toolbar .toolbar-inner {\n  position: absolute;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  left: 0;\n  padding: 0 8px;\n  box-sizing: border-box;\n}\n.toolbar .toolbar-inner a {\n  padding-top: 4px;\n  padding-bottom: 4px;\n  height: 100%;\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  width: 100%;\n  box-sizing: border-box;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  overflow: visible;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  color: #666666;\n}\n.toolbar .toolbar-inner a.v-link-active {\n  color: #01bbba;\n}\n.toolbar .toolbar-inner a i {\n  font-size: 28px;\n}\n.toolbar .toolbar-inner a span {\n  display: block;\n  letter-spacing: .01px;\n  font-size: 10px;\n}\n.toolbar .toolbar-inner a.home i:before {\n  content: '\\E602';\n}\n.toolbar .toolbar-inner a.add i:before {\n  content: '\\E606';\n}\n.toolbar .toolbar-inner a.add {\n  position: relative;\n  z-index: 16;\n}\n.toolbar .toolbar-inner a.add i {\n  background: #fff;\n  -webkit-transform: scale(2, 2) translateY(-5px);\n          transform: scale(2, 2) translateY(-5px);\n}\n.toolbar .toolbar-inner a.add span {\n  display: none;\n}\n.toolbar .toolbar-inner a.person i:before {\n  content: '\\E605';\n}\n", "", {"version":3,"sources":["/./public/app/modules/toolbar/index.vue"],"names":[],"mappings":"AAAA;EACE,gBAAgB;EAChB,4CAA4C;EAC5C,aAAa;EACb,cAAc;EACd,QAAQ;EACR,UAAU;EACV,YAAY;EACZ,uBAAuB;EACvB,gBAAgB;EAChB,oCAA4B;UAA5B,4BAA4B;CAC7B;AACD;EACE,OAAO;EACP,eAAe;EACf,gCAAwB;UAAxB,wBAAwB;EACxB,mBAAmB;EACnB,YAAY;EACZ,0BAA0B;EAC1B,YAAY;EACZ,YAAY;EACZ,YAAY;EACZ,YAAY;EACZ,QAAQ;CACT;AACD;EACE,mBAAmB;EACnB,OAAO;EACP,YAAY;EACZ,aAAa;EACb,qBAAc;EAAd,qBAAc;EAAd,cAAc;EACd,0BAA+B;MAA/B,uBAA+B;UAA/B,+BAA+B;EAC/B,0BAAoB;MAApB,uBAAoB;UAApB,oBAAoB;EACpB,QAAQ;EACR,eAAe;EACf,uBAAuB;CACxB;AACD;EACE,iBAAiB;EACjB,oBAAoB;EACpB,aAAa;EACb,0BAA+B;MAA/B,uBAA+B;UAA/B,+BAA+B;EAC/B,YAAY;EACZ,uBAAuB;EACvB,qBAAc;EAAd,qBAAc;EAAd,cAAc;EACd,0BAAoB;MAApB,uBAAoB;UAApB,oBAAoB;EACpB,kBAAkB;EAClB,6BAAuB;EAAvB,8BAAuB;MAAvB,2BAAuB;UAAvB,uBAAuB;EACvB,eAAe;CAChB;AACD;EACE,eAAe;CAChB;AACD;EACE,gBAAgB;CACjB;AACD;EACE,eAAe;EACf,sBAAsB;EACtB,gBAAgB;CACjB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,mBAAmB;EACnB,YAAY;CACb;AACD;EACE,iBAAiB;EACjB,gDAAwC;UAAxC,wCAAwC;CACzC;AACD;EACE,cAAc;CACf;AACD;EACE,iBAAiB;CAClB","file":"index.vue","sourcesContent":[".toolbar {\n  position: fixed;\n  background-color: rgba(247, 247, 248, 0.85);\n  height: 50px;\n  z-index: 5001;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  box-sizing: border-box;\n  font-size: 17px;\n  backface-visibility: hidden;\n}\n.toolbar:before {\n  top: 0;\n  display: block;\n  transform-origin: 50% 0;\n  position: absolute;\n  height: 1px;\n  background-color: #c4c4c4;\n  z-index: 15;\n  width: 100%;\n  content: '';\n  right: auto;\n  left: 0;\n}\n.toolbar .toolbar-inner {\n  position: absolute;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  left: 0;\n  padding: 0 8px;\n  box-sizing: border-box;\n}\n.toolbar .toolbar-inner a {\n  padding-top: 4px;\n  padding-bottom: 4px;\n  height: 100%;\n  justify-content: space-between;\n  width: 100%;\n  box-sizing: border-box;\n  display: flex;\n  align-items: center;\n  overflow: visible;\n  flex-direction: column;\n  color: #666666;\n}\n.toolbar .toolbar-inner a.v-link-active {\n  color: #01bbba;\n}\n.toolbar .toolbar-inner a i {\n  font-size: 28px;\n}\n.toolbar .toolbar-inner a span {\n  display: block;\n  letter-spacing: .01px;\n  font-size: 10px;\n}\n.toolbar .toolbar-inner a.home i:before {\n  content: '\\e602';\n}\n.toolbar .toolbar-inner a.add i:before {\n  content: '\\e606';\n}\n.toolbar .toolbar-inner a.add {\n  position: relative;\n  z-index: 16;\n}\n.toolbar .toolbar-inner a.add i {\n  background: #fff;\n  transform: scale(2, 2) translateY(-5px);\n}\n.toolbar .toolbar-inner a.add span {\n  display: none;\n}\n.toolbar .toolbar-inner a.person i:before {\n  content: '\\e605';\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toolbarList = []; // <style lang="less">
	//     @import "style.less";
	// </style>
	// <template>
	//     <div class="toolbar">
	//         <div class="toolbar-inner">
	//             <a :class="[item.name]" v-for="item in list" v-link="{name:item.name,exact:true}">
	//                 <i class="iconfont"></i>
	//                 <span>{{item.text}}</span>
	//             </a>
	//             <slot></slot>
	...
	for (var key in _router2.default) {
	    if (_router2.default[key].text) {
	        toolbarList.push({
	            text: _router2.default[key].text,
	            name: _router2.default[key].name,
	            path: key
	        });
	    }
	}
